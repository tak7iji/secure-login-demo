...
public class AccountController {
	...
	public ResponseEntity<byte[]> showImage(@AuthenticationPrincipal LoggedInUser userDetails){
		UserImage userImage = accountSharedService.getImage(userDetails.getUsername());
		...
		return new ResponseEntity<byte[]>(userImage.getBody(), headers, HttpStatus.OK); 
	}
	
	@RequestMapping(value = "/create", params = "form")
	public String createForm(AccountCreateForm form) {
	...
	public String createConfirm(
		...
		return "redirect:/account/create?confirm";
	}

	@RequestMapping(value = "/create", method = RequestMethod.GET, params = "confirm")
	public String createConfirm(AccountCreateForm form) {
